...
using Grabacr07.KanColleViewer.Models.Migration;
...
namespace AMing.KcvExtension.Core.Generic
{
        ...
        where T : new()
    {
        ...
        {
            get { return Generic.SettingsHelper.SetSettingFilePath(this.SettingDirName, this.SettingFileName); }
            set { }
        }
        /// <summary>
        /// 配置是否已经初始化
        ...
        /// </summary>
        public virtual Action LoadFunc => () => this.Settings = this.SettingFilePath.ReadXml<T>();
        /// <summary>
        /// 保存配置的方法（传null使用默认方法保存）
        /// </summary>
        public virtual Action SaveFunc => () => XmlFileWriterHelper.WriteXml(typeof(T), this.Settings, this.SettingFilePath);
        /// <summary>
        /// 将配置还原为默认值
        /// </summary>
        /// <returns></returns>
