...
namespace AMing.KcvExtension.Core.Hub
{
    ...
    //where T : struct
    {
        ...
        {
            return $"DynamicArgs.{typeof(T).Name}";
        }
    ...
    //where T2 : struct
    {
        ...
        public static string GetValidationKey()
        {
            return $"DynamicArgs.{typeof(T1).Name}.{typeof(T2).Name}";
        }
    ...
    //where T3 : struct
    {
        ...
        public static string GetValidationKey()
        {
            return $"DynamicArgs.{typeof(T1).Name}.{typeof(T2).Name}.{typeof(T3).Name}";
        }
    ...
    //where T4 : struct
    {
        ...
        public static string GetValidationKey()
        {
            return $"DynamicArgs.{typeof(T1).Name}.{typeof(T2).Name}.{typeof(T3).Name}.{typeof(T4).Name}";
        }
    ...
    //where T5 : struct
    {
        ...
        public static string GetValidationKey()
        {
            return $"DynamicArgs.{typeof(T1).Name}.{typeof(T2).Name}.{typeof(T3).Name}.{typeof(T4).Name}.{typeof(T5).Name}";
        }
