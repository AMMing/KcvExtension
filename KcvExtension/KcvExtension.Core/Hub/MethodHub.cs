...
namespace AMing.KcvExtension.Core.Hub
{
    public class MethodHub
    {
        ...
        /// MethodHub的实例
        /// </summary>
        public static MethodHub Current { get; } = new MethodHub();
        ...
        /// 保存所有方法集合
        /// </summary>
        public Dictionary<string, Func<dynamic, dynamic>> MethodDictionary { get; } = new Dictionary<string, Func<dynamic, dynamic>>();
        ...
        {
            return this.GetMethod(key)?.Invoke(args);
        }
